...
public class NoticeController {
    ...
    public String list(NoticePageRequestDTO noticepageRequestDTO, Model model) {
        ...
        // 화면 이름 반환
        return "notice/list"; // notice 폴더 아래 list.html 파일을 참조하도록 설정
    }
...
//    }
    ...
    @GetMapping({"/read"})
    public void read(Long cd, NoticePageRequestDTO noticepageRequestDTO, Model model) {

        log.info("BoardController : /cafe/notice/read  확인 중, noticepageRequestDTO : " + noticepageRequestDTO);
